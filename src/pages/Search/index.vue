        ...
        <div class="bread">
          ...
          <ul class="fl sui-tag">
            ...
            <li
              ...
              :key="index"
            >
              {{ p.split(":")[1] }}<i @click="removeProp(index)">x</i>
            </li>
          </ul>
        </div>
            ...
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li :class="{ active: isOne }" @click="changeOrder('1')">
                  <a
                    >综合<span v-show="isOne">{{ arrow }}</span></a
                  >
                </li>
                <li :class="{ active: isTwo }" @click="changeOrder('2')">
                  <a
                    >价格<span v-show="isTwo">{{ arrow }}</span></a
                  >
                </li>
              </ul>
            </div>
...
export default {
  ...
  computed: {
    ...
    totalPages() {
      return this.searchList.totalPages;
    },
    isOne() {
  ...
  methods: {
    ...
    changeOrder(flag) {
      ...
      if (originOrder.split(":")[0] == flag) {
        let value = originOrder.split(":")[1] == "desc" ? "asc" : "desc";
        this.searchParams.order = `${flag}:${value}`;
        this.getSearch();
      } else {
